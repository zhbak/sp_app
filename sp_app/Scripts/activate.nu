...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\OneDrive\Проекты\2023_СП_прога\sp_app\sp_app'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\OneDrive\Проекты\2023_СП_прога\sp_app\sp_app\Scripts\deactivate.nu'
